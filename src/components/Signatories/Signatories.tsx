...
const data = [
  ...
  "DEFY Brands",
  "Design Activists for Regenerative",
  "Design Burger",
  ...
  "Frankie Thelwell",
  "FranklinTill",
  "Future Island-Island at Ulster University",
  "Future Selves",
  "Futurice Ltd",
  "Fynn",
  "G R Moore Limited",
...
const Signatories: React.FC = () => {
  return (
    <section className="container">
      <section>
        <h1 className={styles.headline}>#513</h1>
        <div className={styles.section}>
          <p className="heading">Signatories and counting in</p>
          <p>D! UK</p>
        </div>
